...
//     try {
//         const response = await axios.post(`http://localhost:2000/api/v1/application/post/${jobId}`,data,{
//             withCredentials:true,
//             headers:{"Content-Type": "multipart/form-data"},
//         });
//         dispatch(applicationSlice.actions.successForPostApplication(response.data.message));
//         dispatch(applicationSlice.actions.clearAllErros());
        
//     } catch (error) {
//         dispatch(applicationSlice.actions.failureForPostApplication(error.response.message));
//     }
// }
...
//     try {
//         const response = await axios.get(`http://localhost:2000/api/v1/application/employee/getall`,{
//             withCredentials:true,
//         });
...
//     } catch (error) {
//         dispatch(applicationSlice.actions.failureForMyApplications(error.response.message));
//     }
// }
...
//     try {
//         const response = await axios.get(`http://localhost:2000/api/v1/application/employer/getall`,{
//             withCredentials:true,
//         });
...
//     } catch (error) {
//         dispatch(applicationSlice.actions.failureForAllApplications(error.response.message));
//     }
// }
...
export const postApplication = (data, jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `http://localhost:2000/api/v1/application/post/${jobId}`,
      data,
      {
        withCredentials: true,
        headers: { "Content-Type": "multipart/form-data" },
...
//       `http://localhost:2000/api/v1/application/employee/getall`,
//       {
//         withCredentials: true,
//       }
//     );
...
export const fetchJobSeekerApplications = () => async (dispatch) => {
  dispatch(applicationSlice.actions.requestForMyApplications());
  try {
    console.log('Sending request to fetch job seeker applications...');
    const response = await axios.get(
      `http://localhost:2000/api/v1/application/employee/getall`,
      {
        withCredentials: true,
...
export const fetchEmployerApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `http://localhost:2000/api/v1/application/employer/getall`,
      {
        withCredentials: true,
      }
    );
...
export const deleteApplication=(id)=>async(dispatch)=>{
  ...
  try {
    const response = await axios.delete(`http://localhost:2000/api/v1/application/delete/${id}`,{
      withCredentials: true,
    });
